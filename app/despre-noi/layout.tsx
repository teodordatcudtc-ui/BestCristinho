...
export const metadata: Metadata = {
  ...
  description: 'Află mai multe despre Service Auto Best Cristinho din Pitești. Peste 17 ani de experiență în reparații auto, echipă profesională și valori de încredere.',
